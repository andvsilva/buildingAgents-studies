...
```bash
~/repo/buildingAgents-studies/agent-ai/API-call on  main! ⌚ 12:01:45
$ python task_1_import_setup.py
✅ Step 1 Complete: Libraries imported!
- openai: For making API calls
- os: For accessing environment variables
Markers directory ready at: /home/andvsilva/repo/buildingAgents-studies/agent-ai/API-call/markers
Import and setup completed successfully.
